...
WORKDIR /src
COPY ["DockerIntegration/DockerIntegration/DockerIntegration/DockerIntegration.csproj", "DockerIntegration/"]
RUN dotnet restore "DockerIntegration/DockerIntegration.csproj"
COPY . .
